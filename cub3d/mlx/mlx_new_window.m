...
- (int)	pixel_management
{
  ...
  glUseProgram(glsl.font_parma);
  glsl.loc_font_texture = glGetUniformLocation(glsl.font_parma, "texture");
  glsl.loc_font_color = glGetUniformLocation(glsl.font_parma, "color");
  glsl.loc_font_posinwin = glGetUniformLocation(glsl.font_parma, "fontposinwin");
  glsl.loc_font_posinatlas = glGetUniformLocation(glsl.font_parma, "fontposinatlas");
  glsl.loc_font_atlassize = glGetUniformLocation(glsl.font_parma, "fontatlassize");
  glsl.loc_font_winhalfsize = glGetUniformLocation(glsl.font_parma, "winhalfsize");
  glsl.loc_font_position = glGetAttribLocation(glsl.font_parma, "position");
  //      printf("err? 0x%x\n", glGetError());
